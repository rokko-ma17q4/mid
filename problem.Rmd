...
Optional problem: Perform a simple linear regression for 1 and 2 to check that the negative correlation is 
statistically significant. (You'll get bonus points.)
